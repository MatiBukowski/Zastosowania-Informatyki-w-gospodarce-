...
RESTAURANTS_DATA = [
    {"name": "Abecadło z pieca spadło,O ziemię się hukło,Rozsypało się po kątach,Strasznie się potłukło:", "address": "ul. Włoska 1, Kraków", "cuisine": CuisineTypeEnum.ITALIAN, "has_kiosk": True},
    {"name": "Burger Joint", "address": "ul. Amerykańska 5, Warszawa", "cuisine": CuisineTypeEnum.AMERICAN, "has_kiosk": False},
    {"name": "Pierogarnia Staropolska", "address": "ul. Rynek 10, Wrocław", "cuisine": CuisineTypeEnum.POLISH, "has_kiosk": True},
    {"name": "Sushi Zen", "address": "ul. Japońska 3, Poznań", "cuisine": CuisineTypeEnum.JAPANESE, "has_kiosk": False},
    {"name": "Taco Loco", "address": "ul. Meksykańska 7, Gdańsk", "cuisine": CuisineTypeEnum.MEXICAN, "has_kiosk": True},
    {"name": "Greek Zorba", "address": "ul. Grecka 2, Łódź", "cuisine": CuisineTypeEnum.GREEK, "has_kiosk": False},
    {"name": "Kebab King", "address": "ul. Turecka 4, Szczecin", "cuisine": CuisineTypeEnum.KEBAB, "has_kiosk": True},
    {"name": "Vegan Paradise", "address": "ul. Zielona 8, Lublin", "cuisine": CuisineTypeEnum.VEGAN, "has_kiosk": False},
]
